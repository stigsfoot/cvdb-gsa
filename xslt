...
<xsl:variable name="logo_url">https://www.google.com/a/cpanel/ibtci.com/images/logo-custom.gif</xsl:variable>
...
<xsl:variable name="search_box_size">40</xsl:variable>

<!-- *** choose search button type: 'text' or 'image' *** -->
<xsl:variable name="choose_search_button">text</xsl:variable>
<xsl:variable name="search_button_text">IBTCI Search</xsl:variable>
...
<xsl:variable name="egds_appliance_tab_label">ASKGoogle</xsl:variable>
...
<select name="site">
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='cv')]">
...
<!--include PPRs 10-10-2011 by noble-->
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='PPRs')]">
   <option value="PPRs" selected="selected">PPRs</option>
  </xsl:when>
  <xsl:otherwise>
   <option value="PPRs">PPRs</option>
  </xsl:otherwise>
 </xsl:choose>

<!--end PPR include-->
 <xsl:choose>
  <xsl:when test="PARAM[(@name='site') and (@value='reports')]">
   <option value="reports" selected="selected">reports</option>
  </xsl:when>
  <xsl:otherwise>
...
<xsl:template name="copyright">
  <center>
    ...
    <font face="arial,sans-serif" size="-1" color="#2f2f2f">
      Powered by Google Search Appliance Modified by | <a href="http://www.managedcompany.com">Managed Company</a></font>
    </p>
  </center>
</xsl:template>
...
<xsl:template name="desktop_tab">
  ...
  <!-- *** Show the Google tabs *** --><!-- modifications Noble A. 11.21.2011 -->

  <font size="-1">
    <a class="q" onClick="return window.qs?qs(this):1" href="http://www.ibtci.com">Web</a>
  </font>

  <xsl:call-template name="nbsp4"/>

  <font size="-1">
    <a class="q" onClick="return window.qs?qs(this):1" href="http://calendar.google.com/a/ibtci.com/">Calendar</a>
  </font>

  <xsl:call-template name="nbsp4"/>

  <font size="-1">
    <a class="q" onClick="return window.qs?qs(this):1" href="http://mail.google.com/a/ibtci.com/">Mail</a>
  </font>

  <xsl:call-template name="nbsp4"/>

  <font size="-1">
    <a class="q" onClick="return window.qs?qs(this):1" href="http://sites.google.com/a/ibtci.com">Intranet</a>
  </font>
